        ...
        <div className="sub_footer">
          ...
          <div className="footer_quick_links">
            ...
            <ul className="footer_links">
              ...
              <li><a className="footer_link" href="#">SERVICES</a></li>
          ...
          <div className="footer_gallery">
            ...
            <div className="footer_images">
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-1.png" className="footer_images" alt="Gallery1" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-2.png" className="footer_images" alt="Gallery2" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-3.png" className="footer_images" alt="Gallery3" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-4.png" className="footer_images" alt="Gallery4" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-5.png" className="footer_images" alt="Gallery5" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-6.png" className="footer_images" alt="Gallery6" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-7.png" className="footer_images" alt="Gallery7" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-8.png" className="footer_images" alt="Gallery8" /></a>
              <a href="#"><img src="./assets/Home-images/Footer-Gallery-9.png" className="footer_images" alt="Gallery9" /></a>
            </div>
          </div>
        </div>
